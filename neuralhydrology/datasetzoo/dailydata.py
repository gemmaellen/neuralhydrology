...
class DailyData(BaseDataset):
    """Data set class for the daily data of multiscale. Altered from camelsus.py.
    ...
    def __init__(self,
        ...
        super(DailyData, self).__init__(cfg=cfg,
                                       is_train=is_train,
                                       period=period,
                                       basin=basin,
    ...
    def _load_basin_data(self, basin: str) -> pd.DataFrame:
        ...
        for forcing in self.cfg.forcings:
            df, area = load_daily_forcings(self.cfg.data_dir, basin, forcing)
        ...
        # add discharge
        df['QObs(mm/d)'] = load_daily_discharge(self.cfg.data_dir, basin, area)
...
def load_daily_forcings(data_dir: Path, basin: str, forcings: str) -> Tuple[pd.DataFrame, int]:
    """Load the forcing data for a basin of the daily data set.
